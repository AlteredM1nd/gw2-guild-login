            ...
            <div class="gw2-admin-card-content">
                ...
                $guild_id = is_string($guild_id_raw) ? $guild_id_raw : '';
                 if ($guild_id !== '') {
                    ...
                    $settings_url_raw = admin_url('admin.php?page=gw2-guild-settings');
        ...
        <div class="gw2-admin-card" role="region" aria-label="Quick Actions">
            ...
            <div class="gw2-admin-card-content">
                <ul class="gw2-admin-actions">
                    <li><a href="<?php echo esc_url(admin_url('admin.php?page=gw2-guild-settings')); ?>" aria-label="Go to Guild Settings">Guild Settings</a></li>
