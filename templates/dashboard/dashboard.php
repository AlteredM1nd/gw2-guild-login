...
if ( ! isset( $gw2_account_id ) ) {
	$gw2_account_id = ''; }
if ( ! isset( $gw2_account_name ) ) {
	$gw2_account_name = ''; }
if ( ! isset( $gw2_world ) ) {
	$gw2_world = ''; }
if ( ! isset( $gw2_created ) ) {
	$gw2_created = ''; }
if ( ! isset( $gw2_guilds ) ) {
	$gw2_guilds = array(); }
if ( ! isset( $last_login ) ) {
...
<img src="<?php echo esc_url( (string) $user_avatar_url_safe ); ?>" alt="<?php echo esc_attr( (string) $user_display_name_safe ); ?>" class="gw2-avatar" />
	...
	<strong>
	<?php
	$account_id_label = esc_html__( 'Account ID:', 'gw2-guild-login' );
	echo esc_html( (string) $account_id_label );
	?>
	</strong> 
	<?php
...
<p class="gw2-account-world">
	<strong>
	<?php
	$world_label = esc_html__( 'World:', 'gw2-guild-login' );
	echo esc_html( (string) $world_label );
	?>
	</strong> 
	<?php
...
<p class="gw2-account-created">
	<strong>
	<?php
	$created_label = esc_html__( 'Created:', 'gw2-guild-login' );
	echo esc_html( (string) $created_label );
	?>
	</strong> 
	<?php
	...
	<strong>
	<?php
	$last_login_label = esc_html__( 'Last Login:', 'gw2-guild-login' );
	echo esc_html( (string) $last_login_label );
	?>
	</strong> 
	<?php
	$login_time = 0;
